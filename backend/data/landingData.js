  ...
  devices: [
    {
      ...
      description:
        "The Hub gives the business vertical a premium physical anchor. It is ideal for sales demos because it shows the product as something you can touch, install, and connect to the live brAIn runtime immediately.",
      imageUrl: "/brand/business-hub-board.svg",
  ...
  plans: [
    {
      slug: "free",
      name: "Free",
      summary: "Free validation lane for one secure access check before managed rollout.",
      annualPrice: 0,
      monthlyPrice: 0,
      deviceAllowance: "1 free validation",
      supportLabel: "Self-service validation",
      automationLabel: "Free secure access",
      featured: false,
      features: [
        "1 SC validation included",
        "No payment required",
        "Instant free validation flow",
        "Paid plans move through admin approval",
      ],
    },
    {
      slug: "starter",
      name: "Starter",
      summary: "Entry managed plan for small teams that want admin-reviewed rollout.",
      annualPrice: 180,
      monthlyPrice: 19,
      deviceAllowance: "1 device connection",
      supportLabel: "Email support",
      automationLabel: "Managed AI launch",
      featured: false,
      features: [
    ...
    },
    {
      slug: "professional",
      name: "Professional",
      summary: "For growing companies that need more automation with admin approval.",
      annualPrice: 490,
      monthlyPrice: 49,
    ...
    },
    {
      slug: "business",
      name: "Business",
      summary: "The commercial sweet spot for scale, reviewed by admin before go-live.",
      annualPrice: 990,
      monthlyPrice: 99,
      ...
      features: [
        ...
        "Admin-reviewed activation flow",
      ],
    },
    {
      slug: "platinum",
      name: "Platinum",
      summary: "Enterprise power for unlimited devices with controlled admin rollout.",
      annualPrice: 1990,
      monthlyPrice: 199,
    ...
    },
    {
      slug: "platinum-plus",
      name: "Platinum+",
      summary: "White-label deployments, usage add-ons, and dedicated admin management.",
      annualPrice: 1990,
      monthlyPrice: 199,
